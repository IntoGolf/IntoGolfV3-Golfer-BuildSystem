  ...
  <div>
    ...
    >
      <q-list bordered separator>
        ...
        <q-item>
          <q-item-section>
            <q-item-label class="overflow-hidden">StrokeIndex</q-item-label>
          </q-item-section>
          <q-item-section>
            <q-item-label class="text-right"
              >{{ hole.strokeindex }}
        ...
        <q-item>
          <q-item-section>
            <q-item-label class="overflow-hidden">Slagen</q-item-label>
          </q-item-section>
          <q-item-section>
            <div class="row">
              <div
        ...
        <q-item>
          <q-item-section>
            <q-item-label class="overflow-hidden">Hole punten</q-item-label>
          </q-item-section>
          <q-item-section>
            <q-item-label class="text-right"
              >{{ hole.stableford }}
        ...
        <q-item>
          <q-item-section>
            <q-item-label class="overflow-hidden">Totaal punten</q-item-label>
          </q-item-section>
          <q-item-section>
            <q-item-label class="text-right"
