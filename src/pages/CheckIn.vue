<template>
    ...
    <q-page-container>
        ...
        <div v-if="settings.app_checkin_pincode === 1">
            ...
            <div class="row q-mt-md">
                <div class="q-ml-auto q-mr-auto q-mb-sm">
                    <q-btn color="secondary" label="0" class="q-ma-sm" v-on:click="pressKey(0)"
                           style="font-size: 24px"/>
                    <q-btn color="secondary" label="1" class="q-ma-sm" v-on:click="pressKey(1)"
                           style="font-size: 24px"/>
                    <q-btn color="secondary" label="2" class="q-ma-sm" v-on:click="pressKey(2)"
                           style="font-size: 24px"/>
                    <q-btn color="secondary" label="3" class="q-ma-sm" v-on:click="pressKey(3)"
                           style="font-size: 24px"/>
                    <q-btn color="secondary" label="4" class="q-ma-sm" v-on:click="pressKey(4)"
                           style="font-size: 24px"/>
                </div>
            </div>
            <div class="row">
                <div class="q-ml-auto q-mr-auto">
                    <q-btn color="secondary" label="5" class="q-ma-sm" v-on:click="pressKey(5)"
                           style="font-size: 24px"/>
                    <q-btn color="secondary" label="6" class="q-ma-sm" v-on:click="pressKey(6)"
                           style="font-size: 24px"/>
                    <q-btn color="secondary" label="7" class="q-ma-sm" v-on:click="pressKey(7)"
                           style="font-size: 24px"/>
                    <q-btn color="secondary" label="8" class="q-ma-sm" v-on:click="pressKey(8)"
                           style="font-size: 24px"/>
                    <q-btn color="secondary" label="9" class="q-ma-sm" v-on:click="pressKey(9)"
                           style="font-size: 24px"/>
                </div>
            </div>
            ...
            <div class="row q-mt-sm">
                <div class="q-ml-auto q-mr-auto">
                    <q-btn color="secondary" label="wissen" v-on:click="onClear" class="q-ma-sm"
                           style="font-size: 24px"/>
                </div>
            </div>
        </div>
        ...
        <div v-else>
            ...
            <h4 class="text-center" v-show="!correct">Klik op onderstaande button om in te checken.</h4>
